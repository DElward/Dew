...
/***************************************************************/
struct dbtree_node * dbtree_new_node(void * keyval,
                                     int    keyvallen,
                                     int keyhash,
                                     void * pdata) {
...
void ** dbtree_find_s(struct dbtree * dbt, char * keyval) {
    ...
    return dbtree_find(dbt, keyval, strlen(keyval) + 1);
}
/***************************************************************/
int dbtree_delete_s(struct dbtree * dbt, char * keyval) {

    return dbtree_delete(dbt, keyval, strlen(keyval) + 1);
}
/***************************************************************/
int dbtree_insert_s(struct dbtree * dbt,
    ...
    return dbtree_insert(dbt, keyval, strlen(keyval) + 1, pdata);
}
/***************************************************************/

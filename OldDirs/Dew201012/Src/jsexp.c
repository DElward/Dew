...
/***************************************************************/
static int jexp_binop_hat(struct jrunexec * jx,
    struct jvarvalue * jvv1,
    struct jvarvalue * jvv2)
{
/*
...
struct jexp_exp_rec { /* jxe_ */
    ...
    { 3, 0, JSPU_HAT               , 1, jexp_binop_hat     , NULL              },
    { 2, 0, JSPU_SLASH             , 0, jexp_binop_div     , NULL              },
    { 2, 0, JSPU_STAR              , 0, jexp_binop_mul     , NULL              },
    { 1, 0, JSPU_PLUS              , 0, jexp_binop_add     , NULL              },
    { 1, 0, JSPU_MINUS             , 0, jexp_binop_sub     , NULL              },
    { 0, 0, 0                      , 0, NULL               , NULL              }
};
...
*/
    ...
    struct jexp_exp_rec * jxra[8];
    struct jvarvalue jvva[8];

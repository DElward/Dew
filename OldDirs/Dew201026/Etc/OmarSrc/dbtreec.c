...
11/17/17 DTE  0.1 Fixed bad bug in dbtree_remove_node()
*/
/***************************************************************/
#include "config.h"
...
void ** dbtree_find_s(struct dbtree * dbt, char * keyval) {
    ...
    return dbtree_find(dbt, keyval, IStrlen(keyval) + 1);
}
/***************************************************************/
int dbtree_delete_s(struct dbtree * dbt, char * keyval) {

    return dbtree_delete(dbt, keyval, IStrlen(keyval) + 1);
}
/***************************************************************/
int dbtree_insert_s(struct dbtree * dbt,
    ...
    return dbtree_insert(dbt, keyval, IStrlen(keyval) + 1, pdata);
}
/***************************************************************/

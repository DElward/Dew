...
#define CMEM_NO_TRACKING    0
#define CMEM_MINIMUM        1
#define CMEM_TRACKING       2

#define DEBUG_CMEM_TYPE     CMEM_TRACKING

#if defined(_DEBUG) ||  defined(DEBUG)
#  define CMEM_TYPE DEBUG_CMEM_TYPE
#else
#  define CMEM_TYPE CMEM_NO_TRACKING
#endif
...
#define Realloc(p,t,n) (t*)TRealloc(p, sizeof(t) * (n))
...
#define Realloc(p,t,n) (t*)TRealloc(p, sizeof(t) * (n), __FILE__, __LINE__)

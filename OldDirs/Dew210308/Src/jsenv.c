...
/***************************************************************/
struct jcontext * jrun_create_function_context(struct jrunexec * jx, struct jvarvalue_function * jvvf)
{
/*
** 03/04/2021
*/
...
*/
    ...
    if (fjvv && fjvv->jvv_dtype == JVV_DTYPE_FUNCTION) {
        jvvf = fjvv->jvv_val.jvv_val_function;
        jx->jx_jfs[jx->jx_njfs]->jfs_jvvf = jvvf;
        jx->jx_jfs[jx->jx_njfs]->jfs_jcx = jrun_create_function_context(jx, jvvf);
        jrun_set_current_jxc(jx, &(jvvf->jvvf_begin_jxc));
    } else {
        jx->jx_jfs[jx->jx_njfs]->jfs_jvvf = NULL;
...
/***************************************************************/
static int jprep_call_global_function_by_name(struct jrunexec * jx, const char * funcname)
{
/*
** 03/01/2021
...
//  #endif
    ...
    if (!jstat) {
        jstat = jprep_call_global_function_by_name(jx, jvvf_main->jvvf_func_name);
    }

...
/***************************************************************/
void jrun_free_function_context(struct jcontext * jcx)
{
/*
** 03/07/2021
*/
...
/***************************************************************/
void jrun_free_function_context_consts(struct jcontext * jcx)
{
/*
** 03/09/2021
*/
    ...
    for (ii = 0; ii < jcx->jcx_jvar->jvar_nconsts; ii++) {
        jvar_free_jvarvalue_data(&(jcx->jcx_jvar->jvar_aconsts[ii]));
    }
}
/***************************************************************/
static void jrun_free_jrunexec(struct jrunexec * jx)
{
    ...
    while (ii > 0) {
        ii--;
        jrun_free_function_context_consts(jx->jx_ajcx[ii]);
        jvar_free_jcontext(jx->jx_ajcx[ii]);
    }
    Free(jx->jx_ajcx);
...
*/
    ...
    if (jx->jx_njfs) {
        rtnjvv = &(jx->jx_jfs[jx->jx_njfs]->jfs_rtnjvv);
    }
...
/***************************************************************/
int jrun_push_jfuncstate(struct jrunexec * jx, struct jvarvalue * fjvv)
{
/*
...
*/
    ...
    } else if (fjvv && fjvv->jvv_dtype == JVV_DTYPE_INTERNAL_METHOD) {
        printf("Internal method call: %s.%s()\n",
            fjvv->jvv_val.jvv_int_method.jvvim_cjvv->jvv_val.jvv_jvvi->jvvi_class_name,
    ...
    jx->jx_jfs[jx->jx_njfs]->jfs_fjvv = fjvv;

    if (fjvv->jvv_dtype == JVV_DTYPE_FUNCTION) {
        jvvf = fjvv->jvv_val.jvv_val_function;
        jx->jx_jfs[jx->jx_njfs]->jfs_jcx = jrun_create_function_context(jx, fjvv->jvv_val.jvv_val_function->jvvf_vars);
        jrun_set_current_jxc(jx, &(jvvf->jvvf_begin_jxc));
    } else if (fjvv && fjvv->jvv_dtype == JVV_DTYPE_INTERNAL_METHOD) {
        jx->jx_jfs[jx->jx_njfs]->jfs_jcx = jrun_create_function_context(jx,
            fjvv->jvv_val.jvv_int_method.jvvim_cjvv->jvv_val.jvv_jvvi->jvvi_jvar);
    } else {
        jx->jx_jfs[jx->jx_njfs]->jfs_jcx = NULL;
    }
...
int jrun_pop_jfuncstate(struct jrunexec * jx)
{
...
#if DEBUG_FUNCTION_CALLS
    if (jx->jx_njfs >= 0) {
        fjvv = jx->jx_jfs[jx->jx_njfs - 1]->jfs_fjvv;
        if (fjvv->jvv_dtype == JVV_DTYPE_FUNCTION) {
    ...
    if (fjvv) {
        if (fjvv->jvv_dtype == JVV_DTYPE_FUNCTION) {
            jrun_free_function_context(
                jx->jx_jfs[jx->jx_njfs-1]->jfs_jcx);
        } else if (fjvv->jvv_dtype == JVV_DTYPE_INTERNAL_METHOD) {
            jrun_free_function_context(
                jx->jx_jfs[jx->jx_njfs-1]->jfs_jcx);
        }
    }
...
*/
    ...
    jx->jx_jxc.jxc_toke_ix    = current_jxc->jxc_toke_ix + 1;
}
/***************************************************************/
...
*/
    ...
    if (jx->jx_njfs) {
        jx->jx_jfs[jx->jx_njfs]->jfs_flags |= JFSFLAG_STRICT_MODE;
    }
...
*/
    ...
    if (jx->jx_njfs) {
        if (jx->jx_jfs[jx->jx_njfs]->jfs_flags & JFSFLAG_STRICT_MODE) strict_mode = 1;
    }
...
*/
    ...
    if (jx->jx_njfs) {
        if (jx->jx_jfs[jx->jx_njfs]->jfs_flags & JFSFLAG_STRICTER_MODE) stricter_mode = 1;
    }
...
**
**
** See also: jexp_skip_inactive_block()
*/
    int jstat = 0;
    int done;
    int braces;
...
/***************************************************************/
static int jrun_call_global_function_by_name(struct jrunexec * jx, const char * funcname)
{
/*
** 03/01/2021
...
//  #endif
    ...
    if (!jstat) {
        jstat = jrun_call_global_function_by_name(jx, jvvf_main->jvvf_func_name);
    }

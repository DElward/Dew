...
/***************************************************************/
static int jprep_generic_statement(
                    struct jrunexec * jx,
                    struct jtoken ** pjtok,
                    int skip_flags)
{
...
*/
    ...
    if (jstat) {
        ...
        if (jvv->jvv_dtype != JVV_DTYPE_FUNCTION ||
            ...
            jstat = jvar_new_local_function(jx, jvvf_parent, jvv->jvv_val.jvv_val_function);
        }
    }
...
*/
    ...
    while (!jstat && !done) {
        ...
        switch ((*pjtok)->jtok_kw) {
            ...
            default:
                jstat = jprep_generic_statement(jx, pjtok, skip_flags);
                break;
        }
    }

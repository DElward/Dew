...
*/
    ...
    fjvv->jvv_val.jvv_int_method.jvvim_method = ifuncptr;
    fjvv->jvv_val.jvv_int_method.jvvim_method_name = Strdup(method_name);
    fjvv->jvv_val.jvv_int_method.jvvim_cjvv = jvv;
    ...
    struct jvarvalue * cjvv)
{
    ...
    obj_jvv->jvv_val.jvv_jvvo.jvvo_jcx   = jvar_new_jcontext(jx,
        cjvv->jvv_val.jvv_jvvi->jvvi_jvar, NULL);

...
// 167 - 08/19/2021
function func167() {
    if (2 ** (3 * (2 + 1)) - 500 == -(2 ** 3) + 20)  { return ("Good test 167"); }
}
console.log(func167());
console.log("-- --");
...
// 166 - 08/19/2021
function func166() {
    if (8 + 3 * 2 ** 3 ** 2 * 2 - 80 == 3000)  { return ("Good test 166"); }
}
console.log(func166());
console.log("-- --");
...
// 165 - 08/19/2021
function func165() {
    if (1 + 2 * 3 * 4 + 5 == 50 - 4 * 5)  { return ("Good test 165"); }
}
console.log(func165());
console.log("-- --");
...
// 164 - 07/21/2021
function func164() {
    if (false) { return ("Bad test 164a"); }
    if (false) { return ("Bad test 164b"); }
    if (false) { return ("Bad test 164c"); }
    if (false) { return ("Bad test 164d"); }
    if (true)  { return ("Good test 164"); }
}
console.log(func164());
console.log("-- --");
...
// 159 - 11/06/2019
if (true) {
    if (false) console.log( "Bad test 159a");
    if (false) console.log( "Bad test 159b");
    if (false) console.log( "Bad test 159c");
    if (false) console.log( "Bad test 159d");
    if (true)  console.log( "Good test 159");
}
console.log( "-- --");

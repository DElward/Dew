...
*/
    ...
    if (jvvobject->jvv_dtype != JVV_DTYPE_OBJPTR) {
        jstat = jrun_set_error(jx, errtyp_InternalError, JSERR_INTERNAL_ERROR,
            "Internal error: Expecting object pointer.");
        return (jstat);
    }
    if (jvvobject->jvv_val.jvv_objptr.jvvp_pval->jvv_dtype != JVV_DTYPE_OBJECT) {
        jstat = jrun_set_error(jx, errtyp_InternalError, JSERR_INTERNAL_ERROR,
            "Internal error: Expecting object pointer.");
        return (jstat);
    }
    ...
    jvvb = jvvobject->jvv_val.jvv_objptr.jvvp_pval->jvv_val.jvv_val_object;

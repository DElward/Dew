...
function flev2_101_28(tvers, vint, vstr, vfunc, varr, vel) {
    ...
    //good//if (varr[1].toString() == '77,88') ngood = ngood + 1; else { console.log("Test 101_28" + tvers + "7 failed"); nerrs = nerrs + 1; }
    ...
    //good//if (fxparent_101_28(varr)[1].toString() == '77,88') ngood = ngood + 1; else { console.log("Test 101_28" + tvers + "17 failed"); nerrs = nerrs + 1; }
    //good//if (fxparent_101_28(varr[1]).toString() == '77,88') ngood = ngood + 1; else { console.log("Test 101_28" + tvers + "18 failed"); nerrs = nerrs + 1; }
...
//good//flev2_101_28('c', 6 * (88 + 40 ** 2), "01Alpha23".substring(2, 7),
//good//    func_101_28, ['beta', [1, [77, 88], 'three']][1], ['one', [44, "fi" + "ve"]][1][1]);
////////////////////////////////////////////////////////////////////////

...
*/
    ...
    (*outstr) = NULL;
    jstat = jpr_jvarvalue_tostring(jx, outstr, &prlen, &prmax, jvv, JFMT_FLAGS_LOG);
...
*/
    int jstat = 0;
    struct jintobj_util * jiou = (struct jintobj_util *)this_obj;
    int ii;
    char * logstr;
    char * pbuf;
    int    pbuflen;

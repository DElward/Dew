...
enum e_jti_type {
    ...
    JTI_TYPE_OPEN_BRACE,
    JTI_TYPE_FUNCTION,
    JTI_TYPE_FUNCTION_OPERAND,
    JTI_TYPE_FOR,
    JTI_TYPE_WHILE
};

struct jtifuncoper {   /* jtifo_ */
    struct jvarvalue        jtifo_fjvv;
    struct jxcursor         jtifo_end_jxc; 
};

struct jtiopenbrace {   /* jtiob_ */
    struct jvarrec *        jtiob_jvar;
    struct jxcursor         jtiob_end_jxc; 
};

struct jtokeninfo { /* jti_ */
    enum e_jti_type jti_type;
    union {
        void *                  jti_none;
        struct jtiopenbrace *   jti_val_jtiob;      /* JTI_TYPE_FUNCTION_OPERAND */
        struct jvarrec *        jtibr_jvar;         /* JTI_TYPE_OPEN_BRACE */
        struct jxcursor *       jtifu_end_jxc;      /* JTI_TYPE_FUNCTION */
        struct jtifuncoper *    jtifo;              /* JTI_TYPE_FUNCTION_OPERAND */
    } jti_val;
};

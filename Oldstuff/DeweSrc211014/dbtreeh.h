...
#define dbtsi_rewind(dbtsi,mode) dbtree_rewind((struct dbtree*)(dbtsi),(mode));
#define dbtsi_next(vcs) (int*)dbtree_next(vcs);
#define dbtsi_close(vcs) dbtree_close(vcs);
#define dbtsi_get_key(vcs,pklen) (char*)dbtree_get_key((vcs),(pklen));
